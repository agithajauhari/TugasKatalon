...
WebUI.selectOptionByValue(findTestObject('dropdown'), 'high_to_low', false)

List<WebElement> dataList = WebUI.findWebElements(findTestObject('Object Repository/priceList_list'), 0)
