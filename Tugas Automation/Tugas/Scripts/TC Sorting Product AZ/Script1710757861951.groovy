...
WebUI.selectOptionByValue(findTestObject('dropdown'), 'az', false)

List<WebElement> dataList = WebUI.findWebElements(findTestObject('Object Repository/product_list'), 0)
